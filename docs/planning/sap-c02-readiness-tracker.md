...
- [ ] Under separate explicit approval, configure GuardDuty delegated
  administration in `Security Tooling` only if the live implementation boundary
  is approved.
