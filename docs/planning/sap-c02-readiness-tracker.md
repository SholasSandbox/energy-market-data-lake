...
but MFA and procedural-test evidence still pending:
...
- [ ] Before any live root-user emergency-only SCP attachment, preserve
  management-account-path and root-user MFA evidence, generate/store the
