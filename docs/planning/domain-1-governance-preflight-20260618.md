...
- `/Users/shola/Kiro-Workspace/handlers/LEARNING-PLAN.md`, which keeps the
...
|---|---|---|
| `shola-cloud-lab` | AWS Organizations management account | Owns organization-level billing and governance administration. It is not the lakehouse workload account. |
| `Olusola_AWS` | Member account | Energy Data Lakehouse workload account and the account used for lakehouse evidence. |
