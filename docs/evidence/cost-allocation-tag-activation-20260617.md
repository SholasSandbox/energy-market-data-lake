...
```json
{
  ...
  "Arn": "arn:aws:sts::349687196588:assumed-role/AWSReservedSSO_AdministratorAccess_be84055d6f72e1b2/org-admin-principal"
}
```
...
|---|---|---|
| `349687196588` | `management-account-alias` | AWS Organizations management account |
| `464975959576` | `lakehouse-workload-account` | Energy Data Lakehouse workload/member account |
